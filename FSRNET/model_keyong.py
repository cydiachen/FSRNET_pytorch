...
class Net(torch.nn.Module):
    def __init__(self, num_channels, base_filter, upscale_factor):
        ...
        self.Fine_SR_out_conv = nn.Conv2d(base_filter, base_filter, kernel_size=3, stride=1, padding=1)

        #在后面的话我们来做Fine SR Decoder
        self.Fine_SR_Decoder_input_conv = nn.Conv2d(num_channels, base_filter, kernel_size=3, stride=1, padding=1)
        
        self.Fine_SR_Decoder_deconv = nn.ConvTranspose2d(base_filter,base_filter *2,kernel_size = 4,stide = 1)
